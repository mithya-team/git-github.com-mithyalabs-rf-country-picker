...
var CloseIcon = utils.createSvgIcon( /*#__PURE__*/React.createElement("path", {
...
var MUICountryPicker = function (props) {
    ...
    return (React__default.createElement(Autocomplete$1, { value: value, options: reactForms.COUNTRY_LIST.map(function (i) { return i.name; }), getOptionLabel: function (o) { return o; }, onChange: handleChange, renderInput: function (params) { return (React__default.createElement(core.TextField, __assign({}, params, { label: "Country" }, renderInputProps, { inputProps: __assign(__assign(__assign({}, params.inputProps), renderInputProps === null || renderInputProps === void 0 ? void 0 : renderInputProps.inputProps), { autoComplete: 'nope' }), error: error, helperText: helperText }))); } }));
};
...
exports.MUICountryPicker = MUICountryPicker;
